...
public:
	//constructors:
	RCRPriors(RCRpriorTypes priorType, std::function <std::vector <double>(std::vector <double>, std::vector <double>)> p); //custom priors
...
public:
	...
	*/
	...
	//PRIORS support:
	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject); //case of there being <1 indepedent variable (x variable) in the function
	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject);

	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject); //case of there being <1 indepedent variable (x variable) in the function
	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject);
	...
	//PRIORS support:
	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject, std::function < double(std::vector <double>, std::vector <double>, std::function < double(double, std::vector <double>) >, std::vector <double>) > gB, double bar_guess);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject, std::function <std::vector<double>(std::vector<std::vector<double> >, std::vector <double>, std::function <double(std::vector <double>, std::vector <double>)>, std::vector<double>) >gB_ND, std::vector <double> bar_ND_guess); //case of there being <1 indepedent variable (x variable) in the function
	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject, std::function < double(std::vector <double>, std::vector <double>, std::function < double(double, std::vector <double>) >, std::vector <double>) > gB, double bar_guess);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector<double> sigma_y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject, std::function <std::vector<double>(std::vector<std::vector<double> >, std::vector <double>, std::function <double(std::vector <double>, std::vector <double>)>, std::vector<double>) >gB_ND, std::vector <double> bar_ND_guess);

	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject, std::function < double(std::vector <double>, std::vector <double>, std::function < double(double, std::vector <double>) >, std::vector <double>) > gB, double bar_guess);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, RCRPriors priorsObject, std::function <std::vector<double>(std::vector<std::vector<double> >, std::vector <double>, std::function <double(std::vector <double>, std::vector <double>)>, std::vector<double>) >gB_ND, std::vector <double> bar_ND_guess); //case of there being <1 indepedent variable (x variable) in the function
	FunctionalForm(std::function <double(double, std::vector <double> )> f, std::vector <double> x, std::vector<double> y, std::vector <std::function <double(double, std::vector <double>)> > partialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject, std::function < double(std::vector <double>, std::vector <double>, std::function < double(double, std::vector <double>) >, std::vector <double>) > gB, double bar_guess);
	FunctionalForm(std::function <double(std::vector <double>, std::vector <double>)> f_ND, std::vector < std::vector <double> > x, std::vector<double> y, std::vector <std::function <double(std::vector <double>, std::vector <double>)> > NDpartialsvector, double tolerance, std::vector <double> guess, std::vector <double> w, RCRPriors priorsObject, std::function <std::vector<double>(std::vector<std::vector<double> >, std::vector <double>, std::function <double(std::vector <double>, std::vector <double>)>, std::vector<double>) >gB_ND, std::vector <double> bar_ND_guess);

...
SRC_DIR = 'src'
SRC_FILES = [
    os.path.join(SRC_DIR, 'RCR_python.cpp'),
    os.path.join(SRC_DIR, 'RCR.cpp'),
    os.path.join(SRC_DIR, 'NonParametric.cpp'),
    os.path.join(SRC_DIR, 'FunctionalForm.cpp'),
    os.path.join(SRC_DIR, 'MiscFunctions.cpp')
]
